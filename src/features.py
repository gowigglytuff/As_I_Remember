...
class Feature(object):
    def __init__(self, x, y, imagex, imagey, width, height, img_file_name_list, name, GameController, GameData, offset_y=10):
        self.x = x
        self.y = y
        self.imagex = imagex
        self.imagey = imagey
...
class Person(Feature):
    ...
    def __init__(self, x, y, imagex, imagey, width, height, img_file_name_list, name, GameController, GameData, facing, feature_type, offset_y = 24):

        super().__init__(x, y, imagex, imagey, width, height, img_file_name_list, name, GameController, GameData, offset_y)
...
class Player(Person):
    def __init__(self, x, y, imagex, imagey, width, height, img_file_name_list, name, GameController, GameData):
        super().__init__(x, y, imagex, imagey, width, height, img_file_name_list, name, GameController, GameData, facing="front", feature_type="Player", offset_y=10)
    ...
    def draw(self, screen):
        screen.blit(Spritesheet(self.img).image_at((0, 0, self.width, self.height)),
                    [(self.imagex * self.GameData.square_size[0])+self.GameData.base_locator_x, ((self.imagey * self.GameData.square_size[1])-self.offset_y)+self.GameData.base_locator_y])
    ...
    def walk_cycle(self):
        if self.state == "walk_left":
            if 0 <= self.cur_img < 7:
                ...
                #self.imagex -= 1/16
                self.GameController.camera[0] += 1/8
            ...
            if 0 <= self.cur_img < 7:
                self.set_image(self.cur_img + 1)
                #self.imagey += 1 / 16
                self.GameController.camera[1] -= 1 / 8
...
class NPC(Person):
    def __init__(self, x, y, imagex, imagey, width, height, img_file_name_list, name, GameController, GameData, facing, feature_type, offset_y):

        super().__init__(x, y, imagex, imagey, width, height, img_file_name_list, name, GameController, GameData, facing, feature_type, offset_y)
...
class Pixie(NPC):
    ...
    def __init__(self, x, y, imagex, imagey, width, height, spritesheet, img_file_name_list, name, GameController, GameData):

        super().__init__(x, y, imagex, imagey, width, height, img_file_name_list, name, GameController, GameData, facing = "front", feature_type="Pixie", offset_y=10)

        self.initiate1 = pygame.USEREVENT + 14
        self.action_clock = pygame.USEREVENT + 15
        self.actions = ["turning_left"] #, "turning_right", "turning_front", "turning_back"]
        self.available_actions = ["turn"]
        self.spritesheet = spritesheet

    def set_image(self, img_number):
        self.img = self.spritesheet.get_image(img_number)

    def activate_timers(self):
        pygame.time.set_timer(self.initiate1, 500)
...
class Prop(Feature):
    def __init__(self, x, y, imagex, imagey, width, height, img_file_name_list, name, GameController, GameData, size_x, size_y):
        super().__init__(x, y, imagex, imagey, width, height, img_file_name_list, name, GameController, GameData, offset_y=10)
    ...
    def draw(self, screen):
        screen.blit(Spritesheet(self.img).image_at((0, 0, self.width, self.height)),
                    [((self.imagex + self.GameController.camera[0]) * self.GameData.square_size[
                        0]) + self.GameData.base_locator_x, (((self.imagey + self.GameController.camera[1]) *
                        self.GameData.square_size[1]) - self.offset_y) + self.GameData.base_locator_y])
...
class Decoration(Prop):
    def __init__(self, x, y, imagex, imagey, width, height, img_file_name_list, name, GameController, GameData, size_x, size_y, location_list):
        super().__init__(x, y, imagex, imagey, width, height, img_file_name_list, name, GameController, GameData, size_x, size_y)
