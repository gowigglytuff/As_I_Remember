...
from features import GenericNPC, Spritesheet, ShopKeeper, ShopKeeperTamma, ShopKeeperCheryl
...
class Ringside(Room):
    ...
    def add_room_characters(self):
        ...
        self.gd_input.add_character("Laurie", GenericNPC(32, 101, self.gc_input, self.gd_input, Spritesheet("assets/NPC_sprites/Laurie.png", 32, 40), "Laurie", self.name, "Have you seen my drink anywhere?", "square", Direction.DOWN, Spritesheet("assets/NPC_sprites/faces/NeutralFace.png", 150, 150)))
...
class HornbyCreativeRoom(Room):
    ...
    def add_room_characters(self):
        self.gd_input.add_character("Tamma", ShopKeeperTamma(1, 2, self.gc_input, self.gd_input, Spritesheet("assets/NPC_sprites/Tamma_CS.png", 32, 40), "Tamma", self.name, "Hi, welcome to my store, what would you like to do?", "turning_front", Direction.DOWN, Spritesheet("assets/NPC_sprites/faces/TammaFace.png", 150, 150)))
        self.gd_input.add_character("Cheryl", ShopKeeperCheryl(3, 2, self.gc_input, self.gd_input, Spritesheet("assets/NPC_sprites/Sub_CS.png", 32, 40), "Cheryl", self.name, "Hi, welcome to my store, what would you like to do?", "turning_front", Direction.DOWN, Spritesheet("assets/NPC_sprites/faces/NeutralFace.png", 150, 150)))
        pass
...
class ToTheMoon(Room):
    ...
    def add_room_characters(self):
        self.gd_input.add_character("Guy1", GenericNPC(1, 2, self.gc_input, self.gd_input, Spritesheet("assets/NPC_sprites/Sub_CS.png", 32, 40), "Guy1", self.name, "We've got a lil section by local authors", "stay_front", Direction.DOWN, Spritesheet("assets/NPC_sprites/faces/NeutralFace.png", 150, 150)))
