...
class Ringside(Room):
    ...
    def add_room_characters(self):
        self.gd_input.add_character("Deb", GenericNPC(30, 76, self.gc_input, self.gd_input, Spritesheet("assets/NPC_sprites/Deb.png", 32, 40), "Deb", self.name, "Something strange is going on around here, have you heard about the children disapearing? Their parents couldn't even remember their names...", "stay_left", Direction.DOWN, Spritesheet("assets/NPC_sprites/faces/DebFace.png", 150, 150)))
    ...
    def add_room_props(self):
            ...
            self.gd_input.add_prop(AppleTree.assign_dict_key(), AppleTree(29, 74, self.gc_input, self.gd_input, self.name))
